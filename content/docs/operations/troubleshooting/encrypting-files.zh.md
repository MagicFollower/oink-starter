...
你可以对 [`mc support inspect`](/docs/reference/minio-mc/mc-support-inspect/#command-mc.support.inspect) 命令的输出进行加密，以便在将文件传输到 [MinIO SUBNET](https://min.io/pricing?jmp=docs) 时提升安全性。
...
MinIO 提供了解密工具，用于处理由 [`mc support inspect`](/docs/reference/minio-mc/mc-support-inspect/#command-mc.support.inspect) 生成的文件。
