...
- [HashiCorp KeyVault](/docs/operations/server-side-encryption/configure-minio-kes/#minio-sse-vault)
- [AWS SecretsManager](/docs/operations/server-side-encryption/configure-minio-kes/#minio-sse-aws)
- [Google Cloud SecretManager](/docs/operations/server-side-encryption/configure-minio-kes/#minio-sse-gcp)
- [Azure Key Vault](/docs/operations/server-side-encryption/configure-minio-kes/#minio-sse-azure)
...
关于如何在本地（非生产）MinIO 部署中启用 SSE-KMS， 请参见 [快速开始](/docs/administration/server-side-encryption/server-side-encryption-sse-kms/#minio-encryption-sse-kms-quickstart)。
{{< /tab >}}
...
关于如何在本地（非生产）MinIO 部署中启用 SSE-S3， 请参见 [快速开始](/docs/administration/server-side-encryption/server-side-encryption-sse-s3/#minio-encryption-sse-s3-quickstart)。
{{< /tab >}}
