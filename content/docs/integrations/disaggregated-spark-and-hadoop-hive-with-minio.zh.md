...
- 使用以下任一指南安装 MinIO Distributed Server。
  ...
  - [Deployment based on Kubernetes](https://silo.pgsty.com/docs/operations/deployments/kubernetes/)
  - [Deployment based on MinIO Helm Chart](https://silo.pgsty.com/docs/operations/deployments/k8s-deploy-operator-helm-on-kubernetes/)
