...
- 已有 [MinIO](/docs/operations/deployments/installation/#minio-installation) 部署
...
- 将 [`MINIO_BROWSER_REDIRECT_URL`](/docs/reference/minio-server/settings/console/#envvar.MINIO_BROWSER_REDIRECT_URL) 设置为 MinIO Console 代理主机的 FQDN（`https://example.net/minio/ui`）
{{< /tab >}}
...
- 将 [`MINIO_BROWSER_REDIRECT_URL`](/docs/reference/minio-server/settings/console/#envvar.MINIO_BROWSER_REDIRECT_URL) 设置为 MinIO Console 代理主机的 FQDN（`https://console.example.net/`）
{{< /tab >}}
{{< /tabs >}}