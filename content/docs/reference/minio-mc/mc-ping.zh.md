...
该命令对 [`alias`](/docs/reference/minio-mc/mc-alias/#command-mc.alias) `play` 对应的部署执行五次 ping。 输出类似如下：
...
命令应运行所在位置的 [alias](/docs/reference/minio-mc/mc-alias-set/#minio-mc-alias) 或前缀完整路径。
