...
- 将 `ALIAS` 替换为 MinIO 部署的 [alias](/docs/reference/minio-mc/mc-alias-set/#alias)，以获取 AD/LDAP 集成信息。
...
要输出当前 AD/LDAP 配置的 MinIO 部署 [alias](/docs/reference/minio-mc/mc-alias-set/#alias)。
